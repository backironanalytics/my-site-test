...
reactable(highlight = TRUE, combined_sample_all, columns = list(namePlayer = colDef(name = "Player",
                                                                    ...
                                                                    Bet = colDef(name = "Prop Bet",
                                                                      ...
                                                                      minutes = colDef(name = "Minutes Last 10 GP",cell = function(value,index) {
                                                                        sparkline(combined_sample_all$minutes[[index]], height = 50)
                                                                      }),
                                                                      amount = colDef(name = "Total Last 10 GP",cell = function(value,index) {
                                                                        sparkline(combined_sample_all$amount[[index]], type = "bar", height = 50)
                                                                      }),
                                                                      Under = colDef(name = "Odds"),
                                                                      OU = colDef(name = "O/U"),
                                                                      `Away Games` = colDef(cell = data_bars(combined_sample_all, 
                                                                      ...
                                                                      `Home Games` = colDef(cell = data_bars(combined_sample_all, 
                                                                                                             fill_color = color_set, 
                                                                                                             min_value = 0, 
                                                                                                             max_value = 1, 
                                                                                                             text_position = 'outside-end',
                                                                                                             number_fmt = scales::percent)),
                                                                      `Last 10` = colDef(cell = data_bars(combined_sample_all, 
                                                                                                          fill_color = color_set, 
                                                                                                          min_value = 0, 
                                                                                                          max_value = 1, 
                                                                                                          text_position = 'outside-end',
                                                                                                          number_fmt = scales::percent)),
                                                                      `Last 5` = colDef(cell = data_bars(combined_sample_all, 
                                                                                                         fill_color = color_set, 
                                                                                                         min_value = 0, 
                                                                                                         max_value = 1, 
                                                                                                         text_position = 'outside-end',
                                                                                                         number_fmt = scales::percent)),
                                                                      `Regular Season` = colDef(cell = data_bars(combined_sample_all, 
                                                                                                                 fill_color = color_set, 
                                                                                                                 min_value = 0, 
                                                                                                                 max_value = 1, 
                                                                                                                 text_position = 'outside-end',
                                                                                                                 number_fmt = scales::percent)),
                                                                      `Playoffs` = colDef(cell = data_bars(combined_sample_all, 
                                                                                                                 fill_color = color_set, 
                                                                                                                 min_value = 0, 
                                                                                                                 max_value = 1, 
                                                                                                                 text_position = 'outside-end',
                                                                                                                 number_fmt = scales::percent)),
                                                         `Regular Season + Playoffs` = colDef(cell = data_bars(combined_sample_all, 
                                                                                                                 fill_color = color_set, 
                                                                                                                 min_value = 0, 
                                                                                                                 max_value = 1, 
                                                                                                                 text_position = 'outside-end',
  ...
  add_title("Under Success Rates - SAMPLE") %>% add_subtitle("2024/25 Regular Season & Playoffs") %>% add_subtitle(paste("O/Us & Odds sourced from Draftkings on ",format(Sys.time(), "%a %b %d %Y %X"))) 
```