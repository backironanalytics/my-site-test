...
<center> <p><b>Regular Season Stats</b></p></center>
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(rpg = mean(treb)) %>% pull(rpg))
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(spg = mean(stl)) %>% pull(spg))
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(bpg = mean(blk)) %>% pull(bpg))
...
<center> <p><b>Q1 Stats</b></p></center>
...
valueBox(firstq_makes %>% filter(typeSeason == "Regular Season", slugSeason == current_season) %>% group_by(slugSeason) %>% summarize(ppg = mean(pts)) %>% pull(ppg))
...
valueBox(firstq_assists %>% filter(typeSeason == "Regular Season", slugSeason == current_season) %>% group_by(slugSeason) %>% summarize(apg = mean(assists)) %>% pull(apg))
...
valueBox(firstq_rebounds %>% filter(typeSeason == "Regular Season", slugSeason == current_season) %>% group_by(slugSeason) %>% summarize(rpg = mean(rebounds)) %>% pull(rpg))
...
<center> <p><b>Combo Stats</b></p></center>
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(value = mean(pts+treb+ast)) %>% pull(value))
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(value = mean(pts+ast)) %>% pull(value))
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(value = mean(pts+treb)) %>% pull(value))
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(value = mean(ast+treb)) %>% pull(value))
...
valueBox(player_data %>% filter(slugSeason == current_season, typeSeason == "Regular Season") %>% group_by(namePlayer) %>% summarize(value = mean(stl+blk)) %>% pull(value))
