...
foreach(i = all_players$namePlayer[((length(all_players$namePlayer))*2/3+1):length(all_players$namePlayer)+1], 
        j = all_players$idPlayer[((length(all_players$idPlayer))*2/3+1):length(all_players$idPlayer)+1])  %do% {
