...
team_id_current <- all_rosters %>% filter(idPlayer == player_id) %>% pull(idTeam)
...
Type <- c("2023/24 Regular Season","Last 10 GP","Last 5 GP","2023/24 Regular Season Home","2023/24 Regular Season Away",paste("Against",next_opponent,"Regular Season"),"Second Night of Back of Back",paste(playerdata$slugSeason[1],"Playoffs"),paste(playerdata$slugSeason[1],"Playoffs Away"),paste(playerdata$slugSeason[1],"Playoffs Home"))
...
Leading Indicators {data-navmenu="Leading Indicator Analysis" data-navmenu-icon="fa-chart-area"}
=======================================================================
...
plot_court = function(court_theme = court_themes$custom2, use_short_three = FALSE) {
  if (use_short_three) {
...
shot_summary <- player_q1 %>% select(zoneBasic,nameZone,slugZone,distanceShot,isShotAttempted,isShotMade,typeAction,typeShot,namePlayer) %>% group_by(zoneBasic,namePlayer) %>% summarize(attempts = n(),makes = sum(isShotMade,na.rm = TRUE)) %>% mutate(misses = attempts - makes,fg = makes/attempts) 
...
p1 <- plot_court(court_themes$custom2, use_short_three = F) +
  geom_point(data = player_q1, aes(x = x, y = y, color = player_q1$isShotMade, fill = player_q1$isShotMade), 
             size =2, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("green4","red3"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("green4","red3"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
...
shot_summary <- player_q2 %>% select(zoneBasic,nameZone,slugZone,distanceShot,isShotAttempted,isShotMade,typeAction,typeShot,namePlayer) %>% group_by(zoneBasic,namePlayer) %>% summarize(attempts = n(),makes = sum(isShotMade,na.rm = TRUE)) %>% mutate(misses = attempts - makes,fg = makes/attempts) 
...
p1 <- plot_court(court_themes$custom2, use_short_three = F) +
  geom_point(data = player_q2, aes(x = x, y = y, color = player_q2$isShotMade, fill = player_q2$isShotMade), 
             size =2, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("green4","red3"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("green4","red3"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
...
# Filter shot data for player & clean data to fit court dimensions
player_q3 <- player %>% filter(numberPeriod == 3)

shot_summary <- player_q3 %>% select(zoneBasic,nameZone,slugZone,distanceShot,isShotAttempted,isShotMade,typeAction,typeShot,namePlayer) %>% group_by(zoneBasic,namePlayer) %>% summarize(attempts = n(),makes = sum(isShotMade,na.rm = TRUE)) %>% mutate(misses = attempts - makes,fg = makes/attempts) 
...
p1 <- plot_court(court_themes$custom2, use_short_three = F) +
  geom_point(data = player_q3, aes(x = x, y = y, color = player_q3$isShotMade, fill = player_q3$isShotMade), 
             size =2, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("green4","red3"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("green4","red3"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
...
# Filter shot data for player & clean data to fit court dimensions
player_q4 <- player %>% filter(numberPeriod == 4)

shot_summary <- player_q4 %>% select(zoneBasic,nameZone,slugZone,distanceShot,isShotAttempted,isShotMade,typeAction,typeShot,namePlayer) %>% group_by(zoneBasic,namePlayer) %>% summarize(attempts = n(),makes = sum(isShotMade,na.rm = TRUE)) %>% mutate(misses = attempts - makes,fg = makes/attempts) 
...
p1 <- plot_court(court_themes$custom2, use_short_three = F) +
  geom_point(data = player_q4, aes(x = x, y = y, color = player_q4$isShotMade, fill = player_q4$isShotMade), 
             size =2, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("green4","red3"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("green4","red3"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
...
```{r  season shot chart heatmap, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center'}
...
p1 <- plot_court(court_themes$custom, use_short_three = F) +
  geom_density_2d_filled(player%>% filter(zoneBasic != "Restricted Area"), mapping = aes(x=x,y=y,fill = ..level..,), 
  ...
  ggtitle(label = paste(params$player,"Shot Frequency Heat Map"),
          subtitle = "Regular Season Excludes OT") +
  labs(caption = "Excludes Shots in Restricted Area")
...
```{r  season shot chart Q1, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', eval = FALSE}
...
p1 <- plot_court(court_themes$custom, use_short_three = F) +
  geom_density_2d_filled(player_q1, mapping = aes(x=x,y=y,fill = ..level..,), 
                         contour_var = "ndensity", breaks = seq(0.1, 1.0, length.out = 10), alpha = .5)  +
  scale_fill_manual(values = c(palette), aesthetics = c("fill", "color")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 45)) +
...
```{r  season shot chart Q2, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', eval = FALSE}
...
p1 <- plot_court(court_themes$custom, use_short_three = F) +
  geom_density_2d_filled(player_q2, mapping = aes(x=x,y=y,fill = ..level..,), 
                         contour_var = "ndensity", breaks = seq(0.1, 1.0, length.out = 10), alpha = .5)  +
  scale_fill_manual(values = c(palette), aesthetics = c("fill", "color")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 45)) +
...
```{r  season shot chart Q3, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', eval = FALSE}
...
p1 <- plot_court(court_themes$custom, use_short_three = F) +
  geom_density_2d_filled(player_q3, mapping = aes(x=x,y=y,fill = ..level..,), 
                         contour_var = "ndensity", breaks = seq(0.1, 1.0, length.out = 10), alpha = .5)  +
  scale_fill_manual(values = c(palette), aesthetics = c("fill", "color")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 45)) +
...
```{r  season shot chart Q4, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', eval = FALSE}
...
p1 <- plot_court(court_themes$custom, use_short_three = F) +
  geom_density_2d_filled(player_q4, mapping = aes(x=x,y=y,fill = ..level..,), 
                         contour_var = "ndensity", breaks = seq(0.1, 1.0, length.out = 10), alpha = .5)  +
  scale_fill_manual(values = c(palette), aesthetics = c("fill", "color")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 45)) +
...
### Regular Season Shot Frequency Quarterly Heatmaps

```{r  season shot chart facet test, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center'}
...
p1 <- plot_court(court_themes$custom, use_short_three = F) +
  geom_density_2d_filled(player %>% filter(zoneBasic != "Restricted Area") %>% mutate(numberPeriod = paste0("Q",as.character(numberPeriod))), mapping = aes(x=x,y=y,fill = ..level..,), 
                         contour_var = "ndensity", breaks = seq(0.1, 1.0, length.out = 10), alpha = .5)  +
  scale_fill_manual(values = c(palette), aesthetics = c("fill", "color")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 45)) +
  theme(plot.title = element_text(hjust = .5, size = 11,  face = "bold", vjust = -4),
        plot.subtitle = element_text(hjust = .5, size = 10,  face = "bold", vjust = -8),
        legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank(),
  ...
  ggtitle(label = paste(params$player,"Shot Frequency Heat Map")) +
  labs(caption = "Excludes Restricted Area Shots") + facet_wrap(~ numberPeriod)
...
Defensive Rating Analysis {data-navmenu="Data by Opponent" .hidden}
=======================================================================
...
<center> <p>Current Team: `r team_name` </p></center>
