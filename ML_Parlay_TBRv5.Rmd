...
Type <- c("Regular Season","Last 10 GP","Last 5 GP","Regular Season Home","Regular Season Away",paste("Against",next_opponent,"Regular Season"),"Second Night of Back of Back",paste(playerdata$slugSeason[1],"Playoffs"),paste(playerdata$slugSeason[1],"Playoffs Away"),paste(playerdata$slugSeason[1],"Playoffs Home"))
...
avg_opp <- mean(player_data %>% filter(typeSeason == "Regular Season", slugOpponent == next_opponent) %>% pull(metric))
...
avg <- mean(player_data %>% filter(typeSeason == "Regular Season") %>% pull(metric))
avg_lastx <- mean(player_data %>% arrange(desc(dateGame)) %>% head(params$games) %>% pull(metric))
avg_opponent <- mean(player_data %>% filter(typeSeason == "Regular Season",slugOpponent == next_opponent) %>% pull(metric))
...
avg_opp <- mean(dat %>% filter(typeSeason == "Regular Season", slugOpponent == next_opponent) %>% pull(metric))
...
avg_opp <- mean(firstq_makes %>% filter(typeSeason == "Regular Season", slugOpponent == next_opponent) %>% pull(metric))
...
avg_opp <- mean(firstq_assists %>% filter(typeSeason == "Regular Season", slugOpponent == next_opponent) %>% pull(metric))
...
avg_opp <- mean(firstq_rebounds %>% filter(typeSeason == "Regular Season", slugOpponent == next_opponent) %>% pull(metric))
...
* Against `r next_opponent` in the regular season, `r params$player` has averaged **`r season_opponent$ppg` points per game**, **`r season_opponent$apg` assists per game**, **`r season_opponent$rpg` rebounds per game**
