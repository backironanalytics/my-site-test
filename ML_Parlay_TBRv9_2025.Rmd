...
ggdraw(p1) + theme(plot.background = element_rect(fill="white", color = NA))  + draw_image(pic, scale = .2, x=0.4, y = 0.2) 
...
ggdraw(p1) + theme(plot.background = element_rect(fill="black", color = NA))  + draw_image(pic, scale = .2, x=0.3, y = 0.2) 
...
p <- ggdraw()  + theme(plot.background = element_rect(fill = "#F2DFDD",color = "#F2DFDD"))
