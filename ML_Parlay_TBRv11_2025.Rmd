...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this total game point total is scored when ",params$player," scores at least\n ",round(first,1)," points in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this game assist total happens when ",params$player," has at least\n ",round(first,1)," assists in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this game rebound total happens when ",params$player," has at least\n ",round(first,1)," rebounds in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this game steal total happens when ",params$player," has at least\n ",round(first,1)," steals in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this game block total happens when ",params$player," has at least\n ",round(first,1)," blocks in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this threes made total is scored when ",params$player," makes at least\n ",round(first,1)," threes in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this Pts+Reb+Ast total is attained when ",params$player," has at least\n ",round(first,1)," Pts+Reb+Ast in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this Pts+Ast total is attained when ",params$player," has at least\n ",round(first,1)," Pts+Ast in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this Pts+Reb total is attained when ",params$player," has at least\n ",round(first,1)," Pts+Reb in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this Reb+Ast total is attained when ",params$player," has at least\n ",round(first,1)," Reb+Ast in 1Q: Current Regular Season Only")))))
...
ggplotly(p2) %>% layout(title = list(text = toupper(paste(params$player,"Leading Indicator Analysis",'<br>','<sup>',paste("Likelihood that this Stl+Blk total is attained when ",params$player," has at least\n ",round(first,1)," Stl+Blk in 1Q: Current Regular Season Only")))))
